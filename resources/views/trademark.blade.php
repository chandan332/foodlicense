<div>
        ...
        <div class="container mx-auto px-6 flex flex-col lg:flex-row items-center gap-12">
            ...
            <div class="lg:w-3/5">
                <div class="inline-block bg-orange-500/20 text-brand-orange font-bold px-4 py-1 rounded-full text-sm mb-4">
                    Trademark Registration Starting From ₹699*
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    Trademark Registration
                </h1>
                <p class="text-gray-300 text-lg mb-8 max-w-xl leading-relaxed">
                    Get professional assistance with your trademark application. Submit your basic details and our team will contact you regarding your trademark registration requirement.
                </p>
                
                <div class="hidden lg:block">
                    <p class="text-sm text-gray-400 mb-2">Trusted by brand owners across India</p>
            ...
            <div class="lg:w-2/5 w-full max-w-md mx-auto lg:mx-0">
                <livewire:enquiry-form :service="\App\Enums\ServiceType::Trademark" />
            </div>
        </div>
    </section>

    <!-- TRADEMARK OVERVIEW & PRICING -->
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row gap-12 items-center">
                <div class="md:w-1/2">
                    <h2 class="text-3xl font-bold text-gray-900 mb-6">Trademark Registration</h2>
                    <p class="text-gray-600 mb-6 text-lg leading-relaxed">
                        A trademark can help businesses identify and distinguish their goods or services from those of others. Trademark protection may apply to eligible brand names, logos, symbols and other marks, subject to applicable law and registration requirements.
                    </p>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        Legal Expert India provides professional assistance with the trademark registration process, documentation and related requirements.
                    </p>
                </div>
                ...
                <div class="md:w-1/2 w-full">
                    <div class="bg-white border-2 border-brand-orange rounded-2xl p-8 shadow-xl text-center relative overflow-hidden">
                        ...
                        <div class="text-4xl font-extrabold text-brand-orange my-4">Starting From ₹699*</div>
                        <p class="text-sm text-gray-500 mb-4">
                            Applicable government fees may be separate and can vary depending on the applicant type, number of classes and other applicable requirements.
                        </p>
                        <div class="bg-orange-50 p-4 rounded-lg text-sm text-gray-700 text-left">
                            Service charges and applicable government fees will be communicated before proceeding.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-6">Who Can Apply for a Trademark?</h3>
                    <p class="text-gray-600 mb-4 text-sm">Trademark applications may be relevant for:</p>
                    <ul class="space-y-3">
                        @php
                            $applicants = ['Businesses', 'Startups', 'Companies', 'Proprietors', 'Partnership Firms', 'LLPs', 'Individuals', 'Brand Owners'];
                        @endphp
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li class="bg-gray-50 p-4 rounded-lg border border-gray-100 font-medium text-gray-800">Basic trademark requirement guidance</li>
                        <li class="bg-gray-50 p-4 rounded-lg border border-gray-100 font-medium text-gray-800">Application documentation assistance</li>
                        <li class="bg-gray-50 p-4 rounded-lg border border-gray-100 font-medium text-gray-800">Trademark registration process assistance</li>
                        <li class="bg-gray-50 p-4 rounded-lg border border-gray-100 font-medium text-gray-800">Class-related guidance</li>
                        <li class="bg-gray-50 p-4 rounded-lg border border-gray-100 font-medium text-gray-800">Application status guidance, where applicable</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600 mb-4 text-sm">Requirements may vary depending on the applicant and trademark. Commonly required information may include:</p>
                    <ul class="space-y-3 mb-4">
                        @php
                            $docs = ['Applicant name and details', 'Address and contact details', 'Trademark / brand name or logo', 'Business or applicant information', 'Details of goods or services'];
                        @endphp
                        @foreach($docs as $doc)
            ...
            <div class="max-w-4xl mx-auto space-y-4">
                ...
                <div class="flex items-start space-x-4 p-6 bg-gray-800 rounded-xl border border-gray-700">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 mt-1 text-sm">We review your basic trademark requirement and information.</p>
                    </div>
                </div>
                <div class="flex items-start space-x-4 p-6 bg-gray-800 rounded-xl border border-gray-700">
                ...
                <div class="flex items-start space-x-4 p-6 bg-gray-800 rounded-xl border border-gray-700">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 mt-1 text-sm">We assist with the relevant trademark application process.</p>
                    </div>
                </div>
                <div class="flex items-start space-x-4 p-6 bg-gray-800 rounded-xl border border-gray-700">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-white">Application Status</h4>
    ...
    <section class="py-16 bg-gray-100 text-center">
        <div class="container mx-auto px-6 max-w-5xl text-center">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Need Trademark Registration?</h2>
            ...
            <div class="text-sm text-gray-500 space-y-4 leading-relaxed max-w-4xl mx-auto text-left">
                <p>
                    Legal Expert India is a private professional service and is not a government department or government authority. Trademark applications are examined and decided by the relevant authority under applicable trademark laws and procedures. We do not guarantee registration, approval or a particular outcome.
                </p>
                <p>
